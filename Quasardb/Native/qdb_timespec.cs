...
namespace Quasardb.Native
{
    ...
    internal struct qdb_timespec
    {
        ...
        internal static qdb_timespec MinValue => new qdb_timespec { tv_sec = qdb_time_t.MinValue, tv_nsec = qdb_time_t.MinValue };
        internal static qdb_timespec MaxValue => new qdb_timespec { tv_sec = qdb_time_t.MaxValue, tv_nsec = qdb_time_t.MaxValue };
    };
}
