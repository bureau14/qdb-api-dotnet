...
namespace Quasardb.TimeSeries
{
    ...
    {
        internal QdbInt64Column(QdbTable series, string name) : base(series, name)
        {
        }
        ...
        /// <param name="points">The points to insert</param>
        public void InsertTruncate(IEnumerable<QdbTimeInterval> intervals, QdbInt64PointCollection points)
        {
            var ranges = new InteropableList<qdb_ts_range>(Helpers.GetCountOrDefault(intervals));
            foreach (var interval in intervals)
                ranges.Add(interval.ToNative());
            var error = qdb_api.qdb_ts_int64_insert_truncate(
        ...
        /// <param name="points">The points to insert</param>
        public void InsertTruncate(QdbTimeInterval interval, QdbInt64PointCollection points)
        {
        ...
        {
            InsertTruncate(intervals, new QdbInt64PointCollection(points));
        }
        ...
        {
            InsertTruncate(new[] { interval }, new QdbInt64PointCollection(points));
        }
        ...
        /// <param name="time">The timestamp of the point to insert</param>
        /// <param name="value">The value of the point to insert</param>
        public void InsertTruncate(IEnumerable<QdbTimeInterval> intervals, DateTime time, long? value)
        {
        ...
        /// <param name="time">The timestamp of the point to insert</param>
        /// <param name="value">The value of the point to insert</param>
        public void InsertTruncate(QdbTimeInterval interval, DateTime time, long? value)
        {
        ...
        {
            var result = _aggregator.Int64Aggregate(qdb_ts_aggregation_type.SumOfSquares);
            if (result.Count() == 0)
                throw new QdbEmptyColumnException(Series.Alias, Name);
            return result.Value();
        }
        ...
        public long? SumOfSquares(QdbTimeInterval interval)
        {
            return _aggregator.Int64Aggregate(qdb_ts_aggregation_type.SumOfSquares, interval).Value();
        }
        ...
        public IEnumerable<long?> SumOfSquares(IEnumerable<QdbTimeInterval> intervals)
        {
            return _aggregator.Int64Aggregate(qdb_ts_aggregation_type.SumOfSquares, intervals).Value();
        }
        ...
        public long? Spread()
        {
            var result = _aggregator.Int64Aggregate(qdb_ts_aggregation_type.Spread);
            if (result.Count() == 0)
                throw new QdbEmptyColumnException(Series.Alias, Name);
            return result.Value();
        }
        ...
        public long? Spread(QdbTimeInterval interval)
        {
            return _aggregator.Int64Aggregate(qdb_ts_aggregation_type.Spread, interval).Value();
        }
        ...
        public IEnumerable<long?> Spread(IEnumerable<QdbTimeInterval> intervals)
        {
            return _aggregator.Int64Aggregate(qdb_ts_aggregation_type.Spread, intervals).Value();
        }
        ...
        public Point AbsMin()
        {
            var point = _aggregator.Int64Aggregate(qdb_ts_aggregation_type.AbsMin).AsPoint();
            if (point == null)
                throw new QdbEmptyColumnException(Series.Alias, Name);
            return point;
        }
        ...
        {
            return _aggregator.Int64Aggregate(qdb_ts_aggregation_type.AbsMin, interval).AsPoint();
        }
        ...
        {
            return _aggregator.Int64Aggregate(qdb_ts_aggregation_type.AbsMin, intervals).AsPoint();
        }
        ...
        public Point AbsMax()
        {
            var point = _aggregator.Int64Aggregate(qdb_ts_aggregation_type.AbsMax).AsPoint();
            if (point == null)
                throw new QdbEmptyColumnException(Series.Alias, Name);
            return point;
        }
        ...
        {
            return _aggregator.Int64Aggregate(qdb_ts_aggregation_type.AbsMax, interval).AsPoint();
        }
        ...
        {
            return _aggregator.Int64Aggregate(qdb_ts_aggregation_type.AbsMax, intervals).AsPoint();
        }
        ...
        public long? Product()
        {
            var result = _aggregator.Int64Aggregate(qdb_ts_aggregation_type.Product);
            if (result.Count() == 0)
                throw new QdbEmptyColumnException(Series.Alias, Name);
            return result.Value();
        }
        ...
        public long? Product(QdbTimeInterval interval)
        {
            return _aggregator.Int64Aggregate(qdb_ts_aggregation_type.Product, interval).Value();
        }
        ...
        public IEnumerable<long?> Product(IEnumerable<QdbTimeInterval> intervals)
        {
            return _aggregator.Int64Aggregate(qdb_ts_aggregation_type.Product, intervals).Value();
        }
        ...
        {
            return _aggregator.Int64Aggregate(qdb_ts_aggregation_type.DistinctCount, interval).Count();
        }
        ...
        {
            return _aggregator.Int64Aggregate(qdb_ts_aggregation_type.DistinctCount, intervals).Count();
        }
