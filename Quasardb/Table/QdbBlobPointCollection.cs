...
namespace Quasardb.TimeSeries
{
    ...
    /// </summary>
    public sealed class QdbBlobPointCollection : SafeHandle, IEnumerable<Point>
    {
        ...
        public QdbBlobPointCollection(int initialCapacity = 1024) : base(IntPtr.Zero, true)
        {
        ...
        public QdbBlobPointCollection(IEnumerable<Point> source) : base(IntPtr.Zero, true)
        {
