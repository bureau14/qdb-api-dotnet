...
namespace Quasardb.Tests.Cluster
{
    ...
    public class Keys
    {
        ...
        public void GivenExistingPrefix_ReturnsMatchingEntries()
        {
            ...
            var results = QdbTestCluster.Instance.Keys(new QdbPrefixSelector(prefix, 10));

            CollectionAssert.AreEqual(aliases, results.ToArray());
        }
        ...
        public void GivenExistingSuffix_ReturnsMatchingEntries()
        {
            ...
            var results = QdbTestCluster.Instance.Keys(new QdbSuffixSelector(suffix, 10));
        ...
        public void GivenExistingTag_ReturnsAttachedEntries()
        {
            ...
            var results = QdbTestCluster.Instance.Keys(new QdbTagSelector(tag));

            CollectionAssert.AreEquivalent(aliases, results.ToArray());
        }
