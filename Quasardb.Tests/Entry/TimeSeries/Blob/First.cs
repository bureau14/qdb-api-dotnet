...
namespace Quasardb.Tests.Entry.TimeSeries.Blob
{
    ...
    public class First
    {
        ...
        public void GivenInRangeInterval_ReturnsFirstPointOfInterval()
        {
            ...
            var interval = new QdbFilteredTimeInterval(_points[0].Time.AddHours(1), _points[2].Time);
        ...
        public void GivenSeveralIntervals_ReturnsFirstOfEach()
        {
            ...
            var intervals = new []
            {
                new QdbFilteredTimeInterval(new DateTime(2012, 1, 1), new DateTime(2016, 12, 31)),
