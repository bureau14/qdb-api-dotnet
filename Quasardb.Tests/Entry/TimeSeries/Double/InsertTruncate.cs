...
namespace Quasardb.Tests.Entry.TimeSeries.Double
{
    ...
    {
        public static QdbDoubleColumn CreateColumn(string alias = null, string name = null)
        {
        ...
        {
            var col = CreateColumn();
            var oldPoints = new QdbDoublePointCollection
            {
                {new DateTime(2000, 01, 01), 1},
                {new DateTime(2000, 01, 02), 2},
            };
            var newPoints = new QdbDoublePointCollection
            {
