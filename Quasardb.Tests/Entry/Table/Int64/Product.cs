...
namespace Quasardb.Tests.Entry.Table.Int64
{
    ...
    public class Product
    {
        ...
        [TestMethod]
        public void GivenNoArgument_ReturnsProductOfTable()
        {
            var col = QdbTestCluster.CreateEmptyInt64Column();
            col.Insert(_points);
            ...
            Assert.AreEqual(195990069744L, result);
        }
        ...
        public void GivenInRangeInterval_ReturnsProductOfInterval()
        {
            ...
            Assert.AreEqual(34517448L, result);
        }
        ...
        public void GivenSeveralIntervals_ReturnsProductOfEach()
        {
            ...
            Assert.AreEqual(195990069744L, results[1]);
