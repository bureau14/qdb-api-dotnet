...
namespace Quasardb.Tests.Entry.Table.Double
{
    ...
    public class SampleVariance
    {
        ...
        public void GivenInRangeInterval_ReturnsSampleVarianceOfInterval()
        {
            ...
            Assert.IsNotNull(result);
            Assert.AreEqual(341421.58333333331, result.Value, /*delta=*/1e-10);
        }
        ...
        public void GivenSeveralIntervals_ReturnsSampleVarianceOfEach()
        {
            ...
            Assert.AreEqual(840.5, results[0].Value, /*delta=*/1e-5);
            Assert.IsNotNull(results[1]);
            Assert.AreEqual(6563886.6666666679, results[1].Value, /*delta=*/1e-5);
